...
const ExplorePage: React.FC = () => {
  ...
  const {
    ...
    searchResults,
    hasMore,
  } = useAppSelector((state) => state.memes);
  ...
  return (
    <div
      className={`min-h-screen relative ${
        darkMode ? "bg-[#0e1217]" : "bg-gray-50"
      }`}
    >
      {/* Header */}
      <div className={`py-8 ${darkMode ? "bg-[#0e1217]" : "bg-white"} `}>
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg flex items-center space-x-2 ${
                  darkMode
                    ? "bg-[#1c1f26] hover:bg-gray-600 text-white"
          ...
          {isFilterOpen && (
            <motion.div
              ...
              className={`mt-4 p-4 rounded-lg ${
                darkMode ? "bg-[#1c1f26]" : "bg-white border border-gray-200"
              } shadow-lg`}
            >
