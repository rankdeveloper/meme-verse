...
const MemeDetailsPage: React.FC = () => {
  ...
  const { currentMeme, loading, error } = useAppSelector(
    (state) => state.memes
  );
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-[#0e1217]" : "bg-gray-50"}`}>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-6">
                  ...
                  <span>
                    {formatDistanceToNow(new Date(currentMeme.created_at), {
                      addSuffix: true,
                    })}
                  </span>
                ...
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full overflow-hidden">
                    <img
                      src={
                        profilePic ||
                        "https://mememakerr.netlify.app/img/cat.jpg"
                      }
