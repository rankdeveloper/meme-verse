...
const UploadPage = () => {
  ...
  const generateAICaption = async () => {
    ...
    try {
      ...
      setFormData((prev) => ({
        ...prev,
        caption: data.value || "Funny Caption",
      }));
    } catch (error) {
  ...
  return (
    ...
    >
      <div
        className={`${
          previewmeme ? "blur-sm" : "blur-none"
        } transition-all duration-300`}
      >
        <h1 className="text-2xl md:text-6xl font-bold bg-gradient-to-r p-10 from-purple-500 to-pink-500 bg-clip-text text-transparent text-center animate-gradient-x">
          Create Your Own Memes
        </h1>

        <div
          className={`max-w-2xl mx-auto min-h-screen p-10 ${
            darkMode
              ? "bg-[#1c1f26] backdrop-blur-lg"
        ...
        >
          <div className="flex flex-col justify-center mt-10 gap-6">
            <div className="space-y-2">
              <label className="text-xl font-bold text-purple-400 uppercase tracking-wide">
                Title
              </label>
              <input
                type="text"
                ...
                className={`w-full p-4 text-lg rounded-xl border-2 ${
                  darkMode
                    ? "bg-[#0e1217] border-gray-600 text-white focus:border-purple-500"
            ...
            <div className="space-y-2 ">
              ...
              <div
                className={`relative border-2 border-dashed ${
                  darkMode
                    ? "border-gray-600 hover:border-purple-500 bg-[#0e1217]"
            ...
            <button
              className={`mt-4 p-5 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl font-bold text-xl uppercase tracking-wide transition-all transform 
            `}
      ...
      {previewmeme && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center backdrop-blur-lg animate-fade-in">
          <div className="relative bg-[#0e1217] p-8 rounded-2xl border-2 border-purple-500 shadow-2xl max-w-2xl w-full mx-4">
            <button
